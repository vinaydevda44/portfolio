...
import Zapmart from "../assets/zapmart.png"
           ...
           <div className="group rounded-xl overflow-hidden transition-all duration-300 hover:-translate-y-2 hover:shadow-xl">
            ...
            <div className="p-4 flex flex-col gap-3">
              ...
              <p className="text-gray-600 text-sm leading-relaxed">
               Zapmart is a grocery delivery web application that allows users to browse products, add items to cart, and place orders for fast doorstep delivery. It focuses on a smooth user experience and quick order processing.

              </p>

              <div className="flex gap-4 text-sm font-semibold">
                <a
                  href="https://zapmart-one.vercel.app/"
                  target="_blank"
